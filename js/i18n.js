const I18n = (() => {
  ...
  const DICT = {
    tr: {
      ...
      "dashboard.araclarRaporlarHeading": "Araçlar & Raporlar",
      "dashboard.continueTitle": "Kaldığın yerden devam et",
      "dashboard.continueDesc": "{step} adımında kaldın",
      "dashboard.zayifKonularTitle": "Zayıf Konular Modu",
      "dashboard.zayifKonularEmptyDesc": "Henüz tekrar verisi yok, önce birkaç Tema tamamlayın",
      ...
      "dtzSinav.startConfirm": "DTZ Sınav Modu yaklaşık 70 dakika sürer (Hören 25dk + Lesen 45dk), zamanlayıcı hemen başlar. Devam etmek istiyor musunuz?",
      "dtzSinav.leaveConfirm": "Aktif bir DTZ Sınavınız var, süre işlemeye devam ediyor. Başka bir moda geçmek istediğinize emin misiniz?",
    ...
    en: {
      ...
      "dashboard.araclarRaporlarHeading": "Tools & Reports",
      "dashboard.continueTitle": "Continue where you left off",
      "dashboard.continueDesc": "You left off at the {step} step",
      "dashboard.zayifKonularTitle": "Weak Topics Mode",
      "dashboard.zayifKonularEmptyDesc": "No review data yet, complete a few Topics first",
      "dashboard.redemittelTitle": "Redemittel-Bank",
      ...
      "dtzSinav.startConfirm": "DTZ Exam Mode takes about 70 minutes (Hören 25min + Lesen 45min), the timer starts immediately. Do you want to continue?",
      "dtzSinav.leaveConfirm": "You have an active DTZ Exam, the timer keeps running. Are you sure you want to switch to another mode?",
